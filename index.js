$(document).ready(function () {
    ...
    let s6 = new Score(6, 'DOM Manipulation Using createElement, appendChild, insertBefore, removeChild, etc.', '06/07/2019', '', 'First attempt please review', 0, '../LocalStorage/LocalStorage.html', '');
    let s7 = new Score(7, 'Manipulating CSS Class Properties Using JavaScript', '06/07/2019', '', 'First attempt please review', 0, '../LocalStorage/LocalStorage.html', '');
    let s8 = new Score(8, 'Creating CSS3 Transitions and Animations in CSS and triggering them with JavaScript', '06/07/2019', '', 'First attempt please review', 0, '../LocalStorage/LocalStorage.html', '');
    let s9 = new Score(9, 'Standard JavaScript Events Including those for Mobile Devices(Ex.onTouchBegin, onLoad, etc.) and Animation and Transition Events', '06/07/2019', '', 'First attempt please review', 0, '../LocalStorage/LocalStorage.html', '');
